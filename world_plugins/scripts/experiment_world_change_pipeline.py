...
import cv2
import sys
sys.path.append('/home/ruyi/catkin_ws/src/MarsSim_v2/world_plugins/scripts')
...
def change_world(seed, use_user_H=False, default_height=0.1, use_label=False, mode='height', rock_num=3, bedrock_num=3, BN=(-4.4,4.4,-2.4,2.4)):
    random.seed(seed)
    yaml_file_name = '/home/ruyi/catkin_ws/src/MarsSim_v2/world_plugins/config/mars_terrain_params_real.yaml'
    ...
    save_path = '/home/ruyi/catkin_ws/src/MarsSim_v2/rover_gazebo/models/experiment_terrain'
