...
def generate_class_mat():
    ...
    cv2.imwrite(
        '/home/tipriest/Documents/MarsSim_v2_ws/src/MarsSim/rover_gazebo/models/mars_terrain/whole_tex/terrain_tex.png',
        img,
    )
    # class_mat = class_mat[::-1,:]
    np.save(
        '/home/tipriest/Documents/MarsSim_v2_ws/src/MarsSim/rover_gazebo/models/mars_terrain/whole_tex/terrain_class.npy',
        class_mat,
    )
    # cv2.imshow('img', img)
