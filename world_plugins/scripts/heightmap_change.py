...
def gen_heightmap(img_num):
    ...
    file_path_16 = '/home/xyt/marsim_ws/src/MarsSim_v2/rover_gazebo/models/mars_terrain/choose/heightmaps_int16'
    file_path_8 = '/home/xyt/marsim_ws/src/MarsSim_v2/rover_gazebo/models/mars_terrain/choose/heightmaps_int8'
    # img_name = 'HM8.png'
    ...
    for i in range(num):
        ...
        if cc == 0:
            ...
            axes_y = l
            a = random.random()*180
            label = cv2.ellipse(img=label,center=(x_c,y_c), axes=(axes_x,axes_y), angle=a, startAngle=0, endAngle=360, color=(1), thickness=-1)
