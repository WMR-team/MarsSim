...
def generate_rocks_model_cylinder(
    DEM,
    param_data,
    terrain_class_mat,
    save_path="",
...
def generate_rocks_model_no_collision(
    DEM,
    param_data,
    terrain_class_mat,
    save_path="",
...
def generate_terrain_model(
    ...
    colormap = np.array(
        [[0, 0, 0], [150, 0, 0], [197, 255, 49], [0, 180, 255], [0, 0, 150]]
    )
...
def generate_terrain_model_exp(
    heightmap_name,
    length,
    height,
    save_path="",
...
def generate_flat_terrain_model(
    heightmap_name,
    length,
    height,
    save_path="",
